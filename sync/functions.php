...
function get_encode($file) {
	function r(string $s) { return (string)$s; }

	$string = file_get_contents($file);
	if($string) {
		(chr(239).chr(187).chr(191) == substr($string, 0, 3)) && r('UTF-8 BOM');
		($string === iconv('UTF-8', 'UTF-8', iconv('UTF-8', 'UTF-8', $string))) && r('UTF-8');
		($string === iconv('UTF-8', 'ASCII', iconv('ASCII', 'UTF-8', $string))) && r('ASCII');
		($string === iconv('UTF-8', 'GB2312', iconv('GB2312', 'UTF-8', $string))) && r('GB2312');
	}
